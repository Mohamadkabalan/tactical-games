...
class FrmExportViewSettingsController {
	...
	public static function add_meta_box( $post_type ) {
		if ( FrmProDisplaysController::$post_type != $post_type ) {
			return;
		}
		add_meta_box( 'frm_export_view', __( 'Export View Settings', 'formidable-export-view' ), 'FrmExportViewSettingsController::add_export_view_metabox', FrmProDisplaysController::$post_type, 'advanced', 'high' );
