<div class="frm_grid_container">
	...
	<fieldset class="frm8 frm_form_field">
		<p>
			<input type="radio" id="frm_export_with_params_yes"
				name="options[export_with_params]"
				value="1" <?php checked( isset( $vars['export_with_params'] ) ? $vars['export_with_params'] : false, 1, true ); ?> />
			<label for="frm_export_with_params_yes"><?php esc_html_e( 'Yes (more flexible, not recommended for Views with sensitive data)', 'formidable-export-view' ); ?></label>
		</p>
		<p>
			<input type="radio" id="frm_export_with_params_no"
				name="options[export_with_params]"
				value="0" <?php checked( isset( $vars['export_with_params'] ) ? $vars['export_with_params'] : 0, 0, true ); ?> />
			<label for="frm_export_with_params_no"><?php esc_html_e( 'No (more secure)', 'formidable-export-view' ); ?></label>
		</p>
	</fieldset>
