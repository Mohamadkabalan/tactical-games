<table class="form-table">
	<tr class="form-field" valign="top">
		<td width="200px">
			<label><?php esc_html_e( 'Schedule CSV Export', 'formidable-export_view' ); ?>
		...
		<td>
			<fieldset>
				...
				if ( $has_views ) {
					...
					?>
					<p><?php esc_html_e( 'No Views available for export.', 'formidable-export_view' ); ?></p>
				<?php } ?>
		</td>
	</tr>
	<tr class="form-field" valign="top">
		<td>
			<label><?php esc_html_e( 'Frequency', 'formidable-export-view' ); ?></label>
		</td>
		<td>
			<input value="<?php echo esc_attr( $export_settings->settings->frequency ); ?>"
			...
			<select name="frm_export_view_frequency_period" class="auto_width">
				...
				<option <?php selected( $export_settings->settings->frequency_period, 'months', true ); ?>
						value="months">Months
				</option>
			</select>
		</td>
	...
	<tr class="form-field frm_form_fields" valign="top">
		...
		<td>
			<select name="frm_export_view_csv_format" class="auto_width">
	...
	<tr class="form-field frm_form_fields" valign="top">
		...
		<td>
			<input style="width:45px" id="frm_csv_col_sep" name="frm_export_view_csv_col_sep"
	...
	<tr class="form-field" valign="top">
		<td>
			<label><?php esc_html_e( 'Destination Directory Path', 'formidable-export-view' ); ?></label>
		</td>
		<td>
			<input value="<?php echo esc_attr( $export_settings->settings->upload_dir ); ?>"
			...
			<?php if ( defined( 'ABSPATH' ) ) { ?>
				<p>Root: <?php echo esc_html( ABSPATH ); ?> </p>
			<?php } ?>
		</td>
	</tr>
</table>
