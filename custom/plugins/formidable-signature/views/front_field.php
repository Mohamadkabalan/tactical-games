...
?> style="max-width:<?php echo esc_attr( (int) $styles['width'] ); ?>px;">
	<div class="sig sigWrapper" style="<?php echo esc_attr( $styles['css'] ); ?>">
		...
		<ul class="sigNav">
			<li class="drawIt"><a href="#" class="<?php echo empty( $field['type_it'] ) ? 'current' : ''; ?>" title="<?php echo esc_html( $field['label1'] ); ?>" aria-label="<?php echo esc_html( $field['label1'] ); ?>"><i class="frm_icon_font frm_signature_icon" aria-hidden></i></a></li>
			<li class="typeIt"><a href="#" class="<?php echo ! empty( $field['type_it'] ) ? 'current' : ''; ?>" title="<?php echo esc_html( $field['label2'] ); ?>" aria-label="<?php echo esc_html( $field['label2'] ); ?>"><i class="frm_icon_font frm_keyboard_icon" aria-hidden></i></a></li>
		</ul>
		<?php } ?>
		<div class="typed">
