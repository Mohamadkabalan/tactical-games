...
== Changelog ==
= 1.05 =
* New: Add WooCommerce trigger to API actions.
* Enhancement: Use FrmNotification::stop_emails function if it is callable.
* Fix: Improve compatibility with Woocommerce 3.0 and 3.1.
* Fix: Hide variable product total when form is present in product.
* Fix: Do not show admin notice twice.
